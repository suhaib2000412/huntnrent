		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							<span>Admin</span>
							<div id="more-details">Hunt&rent<i class="fa fa-chevron-down m-l-5"></i></div>
						</div>
					</div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Sliders</span></a>
					</li>
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Orders</span></a>
					</li>
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Categories</span></a>
					</li>
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">App Data</span></a>
					</li>
					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Users</span></a>
					    <ul class="pcoded-submenu">
					        <li><a href="layout-vertical.html" target="_blank">Hunters</a></li>
					        <li><a href="layout-horizontal.html" target="_blank">Renters</a></li>
					    </ul>
					</li>
					<!-- <li class="nav-item pcoded-menu-caption">
